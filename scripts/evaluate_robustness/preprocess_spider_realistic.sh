...
python preprocessing.py \
    ...
    --output_dataset_path "./data/preprocessed_data/preprocessed_spider_realistic_natsql.json" \
    --db_path "./database" \
    --target_type "natsql"
...
python schema_item_classifier.py \
    ...
    --dev_filepath "./data/preprocessed_data/preprocessed_spider_realistic_natsql.json" \
    --output_filepath "./data/preprocessed_data/spider_realistic_with_probs_natsql.json" \
    --use_contents \
    --mode "test"
